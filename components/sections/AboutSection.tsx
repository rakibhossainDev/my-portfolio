        ...
        <div className={cn("transition-all duration-700", hydrated ? "fade-in-content" : "opacity-0")}>
          <header className="max-w-2xl">
            ...
            <div className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base md:text-lg" suppressHydrationWarning>
              {!hydrated ? <Skeleton className="h-7 w-full max-w-lg" /> : sectionLead}
            </div>
          </header>
            ...
            <div className="flex min-h-0 flex-col lg:col-span-5 lg:h-full lg:min-h-0">
              <GlassCard className="flex min-h-[200px] w-full flex-1 flex-col overflow-hidden p-0 sm:min-h-[220px] lg:min-h-0 lg:h-full">
                <div className="relative flex min-h-[200px] w-full flex-1 items-center justify-center overflow-visible bg-gradient-to-br from-violet-100/90 via-white/40 to-blue-100/90 px-4 py-8 sm:px-6 lg:min-h-[240px]">
                  {!hydrated ? (
                    <div className="relative z-[5] aspect-square w-[min(220px,70vw)] sm:w-[min(230px,68vw)]">
                      <Skeleton className="h-full w-full" style={{ clipPath: `url(#${blobClipId})` }} />
                    </div>
                  ) : (
                    <>
                      <div
                ...
                {!hydrated ? (
                  <div className="shrink-0 space-y-3 border-t border-white/50 bg-white/35 p-4 backdrop-blur-md sm:space-y-4 sm:p-5" suppressHydrationWarning>
                      ...
                      {tab === "About" && (
                        <div className="space-y-6">
                          ...
                          <div>
                            ...
                            <div className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
