  ...
  return (
    <div className="flex flex-col overflow-hidden">
      <GlassCard className="flex h-full flex-col overflow-hidden p-0">
        <div className="relative aspect-[16/10] shrink-0 bg-slate-100/50">
...
export function ProjectGrid({ projects, layout = "grid" }: ProjectGridProps) {
  ...
  if (!ready) {
    return (
      <div className={cn("grid gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8 opacity-50", gridClass)}>
        {[1, 2, 3].map((i) => (
              ...
              return (
                ...
                >
                  <GlassCard className="flex h-full flex-col overflow-hidden p-0">
                    ...
                    <div className="mt-3 flex items-center justify-between gap-3 border-t border-white/50 pt-3 sm:mt-4 sm:pt-4 p-4 sm:px-6">
